...
if ($edit) {
        ...
        <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <td>
                        <div class="pmpro_confirmation">
                            ...
                            if (version_compare($wp_version, "3.3") >= 0) {
                                ...
                                ?>
                                <textarea rows="10" cols="80" name="confirmation"
                                          id="confirmation"><?php
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        ?>
                        <input name="initial_payment" type="text" size="20"
                               value="<?php
                ...
                <tr>
                    ...
                    <td><input id="recurring" name="recurring" type="checkbox"
                               value="yes" <?php
                        ...
                        <label for="recurring"><?php
                            _e('Check if this level has a recurring subscription payment.', 'pmpro'); ?></label>
                    </td>
                </tr>
                ...
                <tr class="recurring_info"
                    ...
                    <td>
                        ...
                        ?>
                        <input name="billing_amount" type="text" size="20"
                               value="<?php
                        ...
                        <select id="cycle_period" name="cycle_period">
                            ...
                            { ?>
                        <input id="cycle_number" name="cycle_number" type="text" size="10"
                               value="<?php
                ...
                if ($gateway != "dpo") { ?>
                    ...
                    if (!pmpro_isLevelRecurring($level)) {
                        ...
                        <td>
                            <input id="custom_trial" name="custom_trial" type="checkbox"
                                   value="yes" <?php
                            if (pmpro_isLevelTrial($level)) {
                                echo "checked='checked'";
                            } ?> onclick="jQuery('.trial_info').toggle();"/> <label
                                    for="custom_trial"><?php
                    ...
                    if (!pmpro_isLevelTrial($level)) {
                        ...
                        <td>
                            ...
                            ?>
                            <input name="trial_amount" type="text" size="20"
                                   value="<?php
                            ...
                            <input name="trial_limit" type="text" size="10"
                                   value="<?php
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td><input id="expiration" name="expiration" type="checkbox"
                               value="yes" <?php
                        ...
                        <label for="expiration"><?php
                            _e('Check this to set when membership access expires.', 'pmpro'); ?></label></a>
                    </td>
                </tr>
                ...
                <tr class="expiration_info"
                    ...
                    <th scope="row" valign="top"><label for="billing_amount"><?php
                            ...
                            :</label></th>
                    <td>
                        <input id="expiration_number" name="expiration_number" type="text" size="10"
                               value="<?php
    ...
    <h2 class="alignleft"><?php
        _e('Membership Levels', 'pmpro'); ?> <a
                href="admin.php?page=pmpro-membershiplevels&edit=-1"
        ...
        foreach ($reordered_levels as $level) {
            ...
            if (!pmpro_checkLevelForStripeCompatibility($level) || !pmpro_checkLevelForBraintreeCompatibility(
                ...
                <td class="level_name"><a
                            href="admin.php?page=pmpro-membershiplevels&edit=<?php
                            echo $level->id ?>"><?php
                        echo $level->name ?></a>
                </td>
                <td>
                    ...
                    _e('edit', 'pmpro'); ?>"
                       ...
                       class="button-primary"><?php
                        _e('edit', 'pmpro'); ?></a>&nbsp;<a
                            title="<?php
                            _e('copy', 'pmpro'); ?>"
                            href="admin.php?page=pmpro-membershiplevels&copy=<?php
                            echo $level->id ?>&edit=-1"
                            class="button-secondary"><?php
                        _e('copy', 'pmpro'); ?></a>&nbsp;<a
                            title="<?php
                            _e('delete', 'pmpro'); ?>"
                            href="javascript: askfirst('<?php
                            echo str_replace(
                                "'",
                                "\'",
                                sprintf(
